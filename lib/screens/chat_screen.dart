...
import 'package:chat/widgets/message_textfield.dart';
import 'package:chat/widgets/singleMessage.dart';
                    ...
                    if(snapshot.hasData){
                       ...
                       return ListView.builder(
                           ...
                           itemBuilder: (context, i){
                             bool isMe = snapshot.data.docs[i]['sendId'] == currentUser!.uid;
                             return SingleMessage(message: snapshot.data.docs[i]['message'], isMe: isMe);
                           });
                    }
                    return Center(
